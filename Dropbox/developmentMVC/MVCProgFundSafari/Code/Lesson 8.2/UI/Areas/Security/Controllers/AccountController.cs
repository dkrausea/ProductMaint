...
using CodeCampServerLite.UI.Filters;
using CodeCampServerLite.UI.Models;
using DotNetOpenAuth.AspNet;
using Microsoft.Web.WebPages.OAuth;
using WebMatrix.WebData;

namespace CodeCampServerLite.UI.Areas.Security.Controllers
{
    [Authorize]
    ...
    public class AccountController : Controller
    {
        [ChildActionOnly]
        [AllowAnonymous]
        public PartialViewResult RenderLogonControl()
        {
            bool isAuthenticated = Request.IsAuthenticated;
            string name = isAuthenticated ? User.Identity.Name : null;

            var model = new RenderLogonControlModel
            {
                IsAuthenticated = isAuthenticated,
                Name = name
            };

            return PartialView("_RenderLogOnPartial", model);
        }
