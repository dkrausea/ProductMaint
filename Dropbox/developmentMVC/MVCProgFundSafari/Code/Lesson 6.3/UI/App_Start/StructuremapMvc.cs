...
using CodeCampServerLite.UI.DependencyResolution;
using CodeCampServerLite.UI.Infrastructure.StructureMap;
using StructureMap;
...
namespace CodeCampServerLite.UI.App_Start {
    public static class StructuremapMvc {
        public static void Start() {
			IContainer container = StructureMapConfiguration.BuildContainer();
