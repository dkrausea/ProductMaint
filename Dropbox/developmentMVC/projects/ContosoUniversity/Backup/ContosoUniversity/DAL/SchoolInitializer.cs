    ...
    public class SchoolInitializer : DropCreateDatabaseIfModelChanges<SchoolContext>
    {
        protected override void Seed(SchoolContext context)
        {
           ...
           { 
            ...
            { 
                new Course { CourseID = 1050, Title = "Chemistry",      Credits = 3, Level = "Now", DepartmentID = 3, Instructors = new List<Instructor>() }, 
                new Course { CourseID = 4022, Title = "Microeconomics", Credits = 3, Level = "Now", DepartmentID = 4, Instructors = new List<Instructor>() }, 
                new Course { CourseID = 4041, Title = "Macroeconomics", Credits = 3, Level = "Now", DepartmentID = 4, Instructors = new List<Instructor>() }, 
                new Course { CourseID = 1045, Title = "Calculus",       Credits = 4, Level = "Now", DepartmentID = 2, Instructors = new List<Instructor>() }, 
                new Course { CourseID = 3141, Title = "Trigonometry",   Credits = 4, Level = "Now", DepartmentID = 2, Instructors = new List<Instructor>() }, 
                new Course { CourseID = 2021, Title = "Composition",    Credits = 3, Level = "Now", DepartmentID = 1, Instructors = new List<Instructor>() }, 
                new Course { CourseID = 2042, Title = "Literature",     Credits = 4, Level = "Now", DepartmentID = 1, Instructors = new List<Instructor>() } 
            };
