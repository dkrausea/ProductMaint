...
namespace AreasExample.Controllers {
    ...
    [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
    public class T4MVC_AccountController: AreasExample.Controllers.AccountController {
        ...
        public override System.Web.Mvc.ActionResult ChangePassword(AreasExample.Models.ChangePasswordModel model) {
            var callInfo = new T4MVC_ActionResult(Area, Name, ActionNames.ChangePassword);
        ...
        public override System.Web.Mvc.ActionResult LogOn(AreasExample.Models.LogOnModel model, string returnUrl) {
            var callInfo = new T4MVC_ActionResult(Area, Name, ActionNames.LogOn);
            callInfo.RouteValueDictionary.Add("model", model);
        ...
        public override System.Web.Mvc.ActionResult Register(AreasExample.Models.RegisterModel model) {
            var callInfo = new T4MVC_ActionResult(Area, Name, ActionNames.Register);
            callInfo.RouteValueDictionary.Add("model", model);
            return callInfo;
        }
